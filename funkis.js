...
var tagMap = {
	...
	"tupler" : ["haskell"],
	"anvÃ¤ndardefinierade typer" : ["haskell"],
	...
	"sannolikhetslÃ¤ra" : ["matstat"],
	"markovkedjor" : ["matstat"],
	"stokastisk" : ["matstat"],
	"vÃ¤ntevÃ¤rde" : ["matstat"],
	"varians" : ["matstat"],
	"korrelation" : ["matstat"],
	"stora talens lag" : ["matstat"],
	"centrala grÃ¤nsvÃ¤rdessatsen" : ["matstat"],
	"statistik" : ["matstat"],
	"skattningar" : ["matstat"],
	...
	"rÃ¶relsemÃ¤ngd" : ["fysik"],
	"rÃ¶relsemÃ¤ngdsmoment" : ["fysik"],
	"oscillationer" : ["fysik"],
	"superposition" : ["fysik"],
	"differentialekvationer" : ["fysik"],
	"transienta fÃ¶rlopp" : ["fysik", "el", "regler"],
	"asic" : ["syntes"],
	"fpga" : ["syntes"],
	"vhdl" : ["syntes"],
	"digitala kretsar" : ["syntes"],
	"hÃ¥rdvarukonstruktion" : ["syntes"],
	"processor" : ["syntes", "dst"],
	"tillstÃ¥ndsmaskin" : ["syntes"],
	"dsl" : ["matdom", "advFunc"],
	"domÃ¤nspecifikt sprÃ¥k" : ["matdom"],
	"funktionell programmering" : ["matdom", "advFunc"],
	"programkalkyl" : ["matdom"],
	"kategoriteori" : ["matdom", "advFunc"],
	"medelvÃ¤rdessatser" : ["matdom"],
	...
	"Ã¶msesidig uteslutning" : ["concurrent"],
	"deadlock" : ["concurrent"],
	"livelock" : ["concurrent"],
	...
	"operationsfÃ¶rstÃ¤rkare" : ["el", "elektronik"],
	"elektromagnetism" : ["el"],
	"likstrÃ¶m" : ["el"],
	"strÃ¶m" : ["el"],
	"spÃ¤nning" : ["el"],
	...
	"impulssvar" : ["tss"],
	"stegsvar" : ["tss"],
	"Ã¶verfÃ¶ringsfunktion" : ["tss"],
	"frekvenssvar" : ["tss"],
	"maxwell-boltzmanns fÃ¶rdelningsfunktion" : ["fysik2"],
	"fasta tillstÃ¥nd" : ["fysik2"],
	"kristallstruktur" : ["fysik2"],
	"rÃ¶ntgen" : ["fysik2"],
	"elektrondiffraktion" : ["fysik2"],
	"fermi-diracs fÃ¶rdelningsfunktion" : ["fysik2"],
	"tillstÃ¥ndstÃ¤theter" : ["fysik2"],
	...
	"narratologi" : ["skon"],
	"lÃ¤sarstrategier" : ["skon"],
	"skÃ¶nlitteratur" : ["skon"],
	"tolkning" : ["skon"],
	"mÃ¤nniska-teknologi-samhÃ¤lle" : ["skon"],
	"mts" : ["skon"],
	...
	"implicita sÃ¶ktrÃ¤d" : ["algoritmer"],
	...
	"mÃ¶nsterkort" : ["elektronik"],
	"databas" : ["databas"],
	"sql" : ["databas"],
	"jdbc" : ["databas"],
	"xml" : ["databas"],
	"grafiskt grÃ¤nssnitt" : ["deskonstr"],
	"html" : ["web"],
	"css" : ["web"],
	"javascript" : ["web"],
	"ajax" : ["web"],
